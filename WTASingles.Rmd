...
betting_data_women = read.csv("2022women.csv")
...
for (year in startYear:endYear) {
  ...
  for (row in 1:nrow(year_dat)) {
    ...
    wtaRankings[winner_name] = year_dat[row, "winner_rank"]
    wtaRankings[loser_name] = year_dat[row, "loser_rank"]
...
test_dat = wta_singles_data[[year]]
...
for (row in 1:nrow(betting_data_women)) {
  winner_points = betting_data_women[row, "B365W"]
  loser_points = betting_data_women[row, "B365L"]
